...
:EXPORT_LATEX_HEADER_EXTRA: \geometry{margin=0pt} \newlength{\myrowheight} \setlength{\myrowheight}{\dimexpr(\textheight - 23pt)/5\relax}
:END:
\noindent
\large
    ...
    (dolist (row table)
      (unless (equal 'hline row)
        (let ((name (nth 1 row))
          ...
          (push (format "{学校：昌邑小学 \\\\ 班级：一（4）班 \\\\ 姓名：%s \\\\ 学号：%s}" name id) latex-table)
          (if (< col-count col-num)
              (push " &\n" latex-table)
            (progn
              (push " \\\\\n" latex-table)
              (setq col-count 0))))))
    (format "\\begin{tblr}[long]{hlines, vlines, rows={\\myrowheight}, colspec={*{%s}{X}}}\n%s\\end{tblr}"
            col-num
...
#+RESULTS:
#+begin_export latex
\begin{tblr}[long]{hlines,|*{4}{X|}}
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：张乐欣 \\ 学号：1} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：王若筠 \\ 学号：2} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：陈欢 \\ 学号：3} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：俞欣泽 \\ 学号：4} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：靖星漪 \\ 学号：5} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：徐嘉怡 \\ 学号：6} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：张嘉言 \\ 学号：7} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：孙乐欣 \\ 学号：8} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：张瑞妍 \\ 学号：9} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：王珞妍 \\ 学号：10} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：贾沂昕 \\ 学号：11} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：贾沂怡 \\ 学号：12} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：唐婉 \\ 学号：13} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：鞠凡希 \\ 学号：14} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：谢梦羽 \\ 学号：15} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：程颂恩 \\ 学号：16} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：陈茗舒 \\ 学号：17} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：郭文真 \\ 学号：18} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：鲁一笑 \\ 学号：19} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：龚容若 \\ 学号：20} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：栗梓壹 \\ 学号：21} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：王越 \\ 学号：22} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：吴可非 \\ 学号：24} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：俞昊泽 \\ 学号：25} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：张博宸 \\ 学号：26} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：唐奕淏 \\ 学号：27} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：钟昕辰 \\ 学号：28} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：汲瑞麟 \\ 学号：29} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：郑尚轩 \\ 学号：30} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：常文赫 \\ 学号：31} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：陈沐青 \\ 学号：32} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：吴恒屹 \\ 学号：33} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：吴宸宇 \\ 学号：34} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：钱锦弘 \\ 学号：35} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：钱宸瑜 \\ 学号：36} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：何宇成 \\ 学号：37} \\
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：向东生 \\ 学号：38} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：顾允珵 \\ 学号：39} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：徐怀仁 \\ 学号：40} &
{学校：昌邑小学 \\ 班级：一（4）班 \\ 姓名：程砚书 \\ 学号：41} \\
\end{tblr}
#+end_export
*** 学籍卡
#+begin_src vbscript
