...
#+end_src
*** 评语
#+begin_src python :var tab=data-2024 :var line=12 :results none :python ~/Documents/Ning/.venv/bin/python :dir ~/Documents/Ning/
      ...
      for i, content_lines in enumerate(student_data):
          ...
          if matched_filename:
              ...
              for index in range(8):
                  first_table.cell(line, 3 + index).text = "优秀"

              for index in range(8):
                  first_table.cell(line, 12 + index).text = "合格"
