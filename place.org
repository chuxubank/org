...
:END:
#+ATTR_LATEX: :environment tabularx :width \textwidth :align p{0.5cm}p{2cm}p{3.8cm}Yp{4cm}
...
|   3 | 2026-02-07 | Sydney             | Visit Bondi Beach, coastal walk, Darling Harbour leisure activities.                            | Sydney city hotel    |
